namespace BhuHelpAPI.Infracture.Repositories;
...
public class RoleRepository : IRoleRepository
{
    ...
    public async Task<ResponseModel> CreateAsync(ApplicationRole role)
    {
        ...
        var existingRole = await roleManager.Roles.AnyAsync(mod => mod.Name == role.Name);
        if (existingRole)
        {
    ...
    public async Task<ResponseModel> UpdateAsync(ApplicationRole role)
    {
        ...
        var existingRoleWithNewName = await roleManager.Roles.AnyAsync(mod => mod.Name == role.Name);
